...
class TestOwnerResolver(unittest.TestCase):
    ...
    def test_multiple_owners_array(self):
        ...
        mock_sales_owner = EntityReference(
            id="sales-id", type="team", name="sales-team", fullyQualifiedName="sales-team"
        )
        mock_finance_owner = EntityReference(
            id="finance-id", type="team", name="finance-team", fullyQualifiedName="finance-team"
        )
    ...
    def test_multiple_owners_with_fqn(self):
        ...
        config = {
            "table": {"sales_db.public.orders": ["sales-team", "audit-team"]}
        }
        ...
        mock_audit_owner = EntityReference(
            id="audit-id", type="team", name="audit-team", fullyQualifiedName="audit-team"
        )
